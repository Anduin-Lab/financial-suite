...
class GeneralLedgerTab(ctk.CTkFrame):
    ...
    def reload_ledger(self):
        ...
        try:
            ...
            if df.empty:
                empty_lbl = ctk.CTkLabel(self.table_container, text="No transactions logged yet for this business profile.", font=ctk.CTkFont(slant="italic"), text_color="gray")
            ...
            err_lbl = ctk.CTkLabel(self.table_container, text=f"Ledger reading error: {e}", text_color="red")
